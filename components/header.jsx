...
const Header = () => {
  ...
  // console.warn(isAuthenticated,"is")
  ...
  return (
    <header className="fixed top-6 left-1/2 transform -translate-x-1/2 z-50 w-full max-w-3xl px-4">
      <div className="backdrop-blur-md bg-white/10 flex border-white/20 rounded-full px-4 sm:px-6 md:px-8 py-3 items-center justify-between gap-2">
